...
public class AAC implements ActionListener {
	 ...
	 */
	public AAC(String filename) throws FileNotFoundException, NullKeyException{ 
	...
	public static void main(String[] args) throws FileNotFoundException, KeyNotFoundException, NullKeyException{
